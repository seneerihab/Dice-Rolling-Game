...
const plyer0Name = document.getElementById('name--0');
const plyer1Name = document.getElementById('name--1');
...
const init = function () {
  ...
  plyer0Name.textContent = 'EINSTEIN';
  plyer1Name.textContent = 'NEWTON';
};
init();
...
btnHold.addEventListener('click', function () {
  if (playing) {
    ...
    if (scores[activePlayer] >= 20) {
      ...
      if (activePlayer === 0) {
        plyer0Name.textContent = 'EINSTEIN WINS';
      } else {
        plyer1Name.textContent = 'NEWTON WINS';
      }
